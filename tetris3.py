...
colors = [(247, 19, 247), (247, 187, 19), (19, 240, 247), (239, 119, 163), (175, 119, 239),
...
def menu():  # function to show the menu on the right
    ...
    pygame.draw.lines(fenetre, (255, 0, 0), False, [(460, 125), (580, 125), (580, 245), (460, 245), (460, 125)],
        2)  # The next 7 lines are to display the grid
    ...
    next_shape = menufy(
        next_piece)  # turn the positions of shape in the shapes list (line 11) into position in the grid drawn above 
    for i in next_shape:
    ...
    if pause == 0:
        ...
        pygame.draw.rect(fenetre, (0, 0, 0),
            [557, 360, 10, 30])  # this line and the next are to draw the continue symbol (two parallel rects)
        pygame.draw.rect(fenetre, (0, 0, 0), [573, 360, 10, 30])
    pygame.draw.circle(fenetre, (200, 200, 200), [570, 325], 20)  # draw down button
    textsurface = myfont.render("HighScore : ", False,
        (0, 0, 0))  # the next 4 lines are to display the highscore during session
    ...
    pygame.draw.rect(fenetre, (255, 0, 0),
        [450, 535, 150, 80])  # The next 7 lines are to draw the banner at the bottom of the menu
